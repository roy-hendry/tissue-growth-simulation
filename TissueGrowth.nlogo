...
to go
  ...
  if show-patch-color = false [cp if show-circle? [make-circle]]
...
to make-links
  if pcolor != red[create-links-with children-at -1 -1 create-links-with children-at 1 -1]
  if any? turtles-at -1 1 [create-links-with children-at -2 0]
  if any? turtles-at 1 1 [create-links-with children-at 2 0]
  ask links [set color white set thickness 0.1]
end
...
"# AMPL" 1.0 0 -955883 true "" "plot AMPL / 13.775"
"# CC" 1.0 0 -13345367 true "" "plot CC"
...
"" ""
PENS
"CC vs AMPL" 1.0 2 -13791810 true "" "plotxy AMPL CC"
